...
MAF="0.05"
TOP_N="5"
#plink="/share/pub/chenfk/tools/plink"
...
function curate_pheno_geno_covariates(){
	...
	known_cov=$2
	topN=$3
	/share/pub/xingsl/shilai/project/APA/software/miniforge3/envs/R3.6.3/bin/Rscript $bin/src/curate_pheno_geno_covariates.R -p $dapars2_res -c $known_cov -n $topN
}
