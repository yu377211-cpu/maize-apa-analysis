...
function snp_and_3utr_location(){
	...
	#perl /share/pub/xingsl/shilai/project/APA/3aQTL_link/3seq_PDUI_TPM/tiqu_3UTR.pl /share/pub/xingsl/shilai/project/APA/PAC_3seq_hq/region_dis/three_prime_UTR.bed $dapars2_res ${currDir}/Matrix_eQTL/3UTR_location.txt & 
...
function curate_pheno_geno_covariates(){
	...
	/share/pub/xingsl/shilai/project/APA/software/miniforge3/envs/R3.6.3/bin/Rscript $bin/src/curate_pheno_geno_covariates_forS1960.R -p $dapars2_res -c $known_cov -n $topN
}
