...
ht_main <- Heatmap(
  ...
  row_names_side = "left",
  column_title = "APA usage–expression coupling across tissue",
...
pdf("tissue_main_APA_expr_heatmap.pdf", width = 10, height = 4)
draw(ht_main)
dev.off()
...
pdf("tissue_shared_APA_expr_heatmap.pdf", width = 10, height = 4)
draw(ht_shared)
dev.off()
