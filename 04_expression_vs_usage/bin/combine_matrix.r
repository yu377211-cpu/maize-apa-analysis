...
# 定义文件列表
file_list <- c(
  "ln.updown_longshort.list",
  "mixed.updown_longshort.list",
  "nss.updown_longshort.list",
  "ss.updown_longshort.list",
  "ts.updown_longehort.list",
  "popcorn.updown_longshort.list",
  "sweet.updown_longshort.list"
)
...
cat("✔ 成功生成 main_matrix_by_subpop.csv - 聚合矩阵文件\n")
...
cat("✔ 成功生成 supp_matrix_by_subpop_shared.csv - 比较组的矩阵文件\n")
